...
const JobsCards = ({ title, image, location, posted, type }) => {
  return (
    <div>
        ...
        <Link to={title}>
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <div className="divive-x-2 divide-red-600">
                  ...
                  <span
                    className={`ml-4 text-[13px] text-sm font-small capitalize px-2 rounded-full ${
                      type == "Full time" ? "bg-blue-100 " : type == "Part time" ? "bg-red-100" : 'bg-green-100'
                    }`}
                  >
                    {/* <span className={type=='full time' ? 'bg-[#FFF2E6]':'text-blue-500'}> */}
                    {type}
                  </span>
                </div>
              </div>
          ...
          <div className="mt-4">
            <p className="text-gray-600 text-[15px] w-[80%]">
              ...
              sunt autem provident ipsum beatae sint nulla neque?
